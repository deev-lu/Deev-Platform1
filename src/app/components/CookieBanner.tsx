          ...
          <div className="glass-edge relative overflow-hidden rounded-2xl border border-white/60 dark:border-white/[0.12] bg-white/60 dark:bg-[#0e0e18]/70 backdrop-blur-2xl backdrop-saturate-150 shadow-[0_20px_60px_rgba(0,0,0,0.18)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.6)]">
            ...
            <div className="p-5 sm:p-6">
              <div className="flex items-start gap-3.5 mb-4">
                <div className="shrink-0 w-10 h-10 rounded-xl bg-[#0022FF]/[0.07] dark:bg-[#00C6FF]/[0.10] flex items-center justify-center">
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-2.5">
                <button
                  ...
                  className="flex-1 px-5 py-2.5 rounded-xl text-sm font-semibold text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-white/[0.06] hover:bg-slate-200 dark:hover:bg-white/[0.10] transition-colors duration-200"
                >
                  Reject non-essential
                </button>
                <button
                  onClick={() => choose("accepted")}
                  className="flex-1 px-5 py-2.5 rounded-xl text-sm font-bold text-white transition-all duration-200 hover:-translate-y-px hover:shadow-[0_0_24px_rgba(0,34,255,0.4)]"
