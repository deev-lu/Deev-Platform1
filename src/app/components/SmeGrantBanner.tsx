    ...
    <section className="relative bg-white dark:bg-[#06060a] py-10 sm:py-12 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div
          ...
          viewport={{ once: true }}
          className="glass-edge glass-sheen group relative rounded-3xl border border-emerald-300/60 dark:border-emerald-500/30 bg-gradient-to-br from-emerald-50/60 to-white/30 dark:from-emerald-950/40 dark:to-[#08080c]/60 backdrop-blur-2xl backdrop-saturate-150 p-6 sm:p-8 md:p-10 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_20px_60px_rgba(16,185,129,0.14)] dark:hover:shadow-[0_20px_60px_rgba(16,185,129,0.10)]"
        >
          {/* Soft glow */}
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-center gap-6 lg:gap-10">
            ...
            <div className="flex-1 min-w-0">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/15 text-emerald-700 dark:text-emerald-400 text-xs font-bold uppercase tracking-widest mb-2.5">
            ...
            <button
              ...
              className="group shrink-0 inline-flex items-center justify-center gap-2 px-7 py-4 rounded-2xl font-bold text-base text-white bg-emerald-600 hover:bg-emerald-500 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_40px_rgba(16,185,129,0.4)]"
            >
              See your net price
