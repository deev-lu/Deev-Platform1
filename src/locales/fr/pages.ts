...
export const pages: typeof En = {
  ...
  contact: {
    ...
    form: {
      ...
      submitting: "Envoi…",
      consent: "En envoyant ce formulaire, vous acceptez que nous vous contactions à propos de votre demande. Nous utilisons vos coordonnées uniquement pour y répondre — elles transitent par notre hébergeur et notre service d'e-mail, et pas au-delà.",
      consentLink: "Comment nous traitons vos données",
