...
export const pages: typeof En = {
  ...
  contact: {
    ...
    form: {
      ...
      consent: "Mit dem Absenden erklären Sie sich damit einverstanden, dass wir Sie zu Ihrer Anfrage kontaktieren. Wir verwenden Ihre Angaben ausschließlich, um sie zu beantworten — sie laufen über unseren Hoster und unseren E-Mail-Dienst und gehen nicht darüber hinaus.",
      consentLink: "Wie wir mit Ihren Daten umgehen",
