...
export const pages = {
  ...
  contact: {
    ...
    form: {
      ...
      submit: "Send message",
      submitting: "Sending…",
      consent: "By submitting, you agree we may contact you about your enquiry. We use your details only to answer it — they pass through our host and our email provider and go no further.",
