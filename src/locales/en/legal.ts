/**
 * The legal page. Translated in full, because a term a reader cannot read is
 * not a term they agreed to.
 *
 * `prevails` renders only on the translated versions: a translation is offered
 * for comprehension, and the binding text stays the one the contract was
 * drafted in.
 */
export const legal = {
...
updated: "Last updated: August 2026",
  ...
  cookies: {
    ...
    rowConsent: "Your cookie choices and the record of them: a reference, the date, and the policy version.",
    rowTheme: "Remembers the light or dark appearance you selected.",
    lifeConsent: "12 months",
